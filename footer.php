<?php 
    $options = get_option('newOne_framework')
?>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <p class="mb-2">
                                <a href="<?php echo $options['footer-number'];?>" class="contact-link">
                            ...
                            <ul class="social-icon mb-4">
                                <li class="social-icon-item">
                                    <a href="<?php echo $options['footer-instagram'];?>" class="social-icon-link bi-instagram"></a>
                                </li>

                                <li class="social-icon-item">
                                    <a href="<?php echo $options['footer-twitter'];?>" class="social-icon-link bi-twitter"></a>
                                </li>
                                
                                <li class="social-icon-item">
                                    <a href="<?php echo $options['footer-facebook'];?>" class="social-icon-link bi-facebook"></a>
                                </li>
